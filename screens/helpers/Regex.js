...
var Regex = {
  ...
  validateFaxNumbers: function (val) {
  ...
  validateString: function (val) {
    return /^[a-zA-Z\x20]{1,250}$/.test(val);
  },
  ...
  validateNumberDot: function (val) {
    return /^[0-9]+(\.[0-9]{1,2})?$/.test(val);
  },
  validateNumberSlash: function (val) {
  ...
  validateNumberOrCharacter: function (text) {
